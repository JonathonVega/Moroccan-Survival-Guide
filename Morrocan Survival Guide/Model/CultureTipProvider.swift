...
struct CultureTipProvider {
    ...
    let commodity = [
        "Basic Car (150000 dirham)",
        "Watermelon (35 dirham)",
        "Cilantro/Parsely (2/3 dirham)",
        "Tomato (5 dirham)",
        "Lettuce (3/5 dirham)",
        "Banana (10 dirham)",
        "Apple  (10 dirham)",
        "Chicken (15 dirham per kilo)",
        "Beef (70 dirham per kilo)",
        "Onion (2 dirham per kilo)",
        "Milk (3.30 dirham)",
        "Carrot (4 dirham)",
        "Tagine (29-35 dirham)",
        "Litre water bottle (7 dirham)",
        "Jug of water (15 dirham)",
        ]
